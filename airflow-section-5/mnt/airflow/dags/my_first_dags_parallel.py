...
# this is the portion where i am defining my default args
default_args = {
...
with DAG(dag_id='my_first_dags_parallel', schedule_interval='0 0 * * *', default_args=default_args, catchup=False) as dag:
